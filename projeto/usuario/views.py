...
class UsuarioRegisterActivateView(RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        messages.success(self.request, 'Obrigado por acessar Sistema de Informação para Coleta de Indicadores de Atletas em Esportes de Invasão | SIEI | IFFar Santo Augusto. Esta é a sua área restrita.')
